...
<div class="container">
    ...
    <form action="{{route('dashboard.projects.store')}}" method="POST">
        ...
        <div class="my-3">
          ...
          <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" aria-describedby="title" name="title" value='{{old('title')}}' required>
          @error('title')
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="cover" aria-describedby="cover" name="cover" value='{{old('cover')}}'>
        </div>
